...
type Storage interface {
	...
	UpdateUserBalance(ctx context.Context, externalTx pgx.Tx, userID, accrual int) error
	...
	UpdateOrder(ctx context.Context, externalTx pgx.Tx, orderID, accrual int, status string) error
